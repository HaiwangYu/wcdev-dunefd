...
local thetaXZ = 0*wc.deg; // 0, 10, 20, 30, 45, 60, 75, 80, 82, 84
local deltaZ = 135;

// local stubby_top1 = {
//   tail: wc.point(10, -200, 10, wc.cm),
//   head: wc.point(10 + deltaZ* std.tan(thetaXZ), -200, 10 + deltaZ, wc.cm),
// };
// 
// local stubby_top2 = {
//   tail: wc.point(10, -100, 10, wc.cm),
//   head: wc.point(10 + deltaZ* std.tan(thetaXZ), -100, 10 + deltaZ, wc.cm),
// };
...
//   tail: wc.point(-10, -100, 160, wc.cm),
//   head: wc.point(-10 - deltaZ* std.tan(thetaXZ), -100, 160 + deltaZ, wc.cm),
// };
// 
// local stubby_bottom4 = {
// tail: wc.point(-10, -200, 160, wc.cm),
// head: wc.point(-10 - deltaZ* std.tan(thetaXZ), -200, 160 + deltaZ, wc.cm),
// };
...
//local chndb_maker = import 'pgrapher/experiment/protodunevd/chndb.jsonnet';
...
local magoutput = 'protodunevd-sim-check-deposplat.root';
...
//         // model: '/dune/data/users/wgu/dune10kt_1x2x6/wire-cell-cfg/ts-model/CP49.ts',
//         gpu: false,
//         wait_time: 500, #ms,
//         nloop: 100,
//       },
