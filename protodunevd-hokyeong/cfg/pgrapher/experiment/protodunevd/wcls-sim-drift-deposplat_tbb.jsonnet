...
local tools = btools {
    ...
    // anodes : [btools.anodes[0], btools.anodes[1], btools.anodes[2], btools.anodes[3], btools.anodes[4]],
};
...
local magoutput = 'magnify-protodunevd.root';
